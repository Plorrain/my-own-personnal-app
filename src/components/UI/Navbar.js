...
export default function Example() {
  return (
    <Disclosure as="nav" className="bg-white bg-opacity-50 w-full">
      {({ open }) => (
        <>
        {/* need to figure out how and where to put back 'fixed' wo breaking the code */}
                      ...
                      <a
                        ...
                        className={classNames(
                          item.current
                            ...
                            : "text-blue-900 hover:bg-gray-700 hover:text-white",
